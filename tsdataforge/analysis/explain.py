...
def explain_series(desc: SeriesDescription) -> SeriesExplanation:
    ...
    if "irregular_sampling" in tags:
        ...
        tag_expl["irregular_sampling"] = (
            "Sampling intervals vary noticeably (dt coefficient-of-variation "
            f"≈{dt_cv:.3f}); treat this as an irregularly sampled series."
        )
    ...
    if "trend" in tags:
        ...
        tag_expl["trend"] = (
            ...
            f"(median R²≈{r2:.2f}); typical absolute slope≈{slope:.4g} per time unit."
        )
    ...
    # Autocorrelation-based process type hints
    if "random_walk_like" in tags:
        ...
        tag_expl["random_walk_like"] = (
            ...
            "integrated process (acf1≈{:.3f}).".format(a1)
        )
        ...
        tag_expl["ar1_like"] = (
            ...
            "colored noise (acf1≈{:.3f}).".format(a1)
        )
    ...
    if "bursty" in tags or "heavy_tail" in tags:
        ...
        tag_expl["bursty"] = (
            "Spiky / heavy-tailed behavior detected (median kurtosis≈{:.2f}, "
            "spikiness≈{:.2%}).".format(km, sm)
        )
    ...
    # Always include a pragmatic note
    bullets.append(
