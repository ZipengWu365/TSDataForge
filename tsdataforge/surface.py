...
class PublicSurface:
    ...
    def to_markdown(self) -> str:
        lines = [
            ...
            "",
            "These are the five entry points new users should memorize first for time-series profiling and handoff.",
            "",
    ...
    return PublicSurface(
        ...
        entrypoints=(
            ...
            PublicEntrypoint(
                ...
                "Generate the first human-readable profiling report from a series or dataset.",
                "EDAReport",
                "The package should feel like a time-series profiling layer before it feels like a toolkit.",
            ),
            PublicEntrypoint(
                "handoff",
